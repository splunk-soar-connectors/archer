...
-------- | -------- | ---- | -----------
**endpoint_url** |  required  | string | API endpoint (e.g., http://host/archer)
...
Newly created attachment ID will be returned. Here the attachment would be created on the path specified in 'file repository' section mentioned in the archer instance configuration (https://help.archerirm.cloud/610-en/content/archercontrolpanel/acp_inst_gen_file_repository_path_designating.htm).
